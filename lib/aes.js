...
AES.prototype._hexStringToByteArray = function (input) {
    ...
    */
    ...
    for (let i = 0; i < input.length; i++) {
        ...
        output.push(parseInt(input[reArrangeIndex[i]], 16));
    }
    ...
    */
    ...
    for (let i = 4; i < wCount; i++) {
        ...
        if (i % 4 === 0) {
            ...
            // console.log('rotBytes', this._byteArrayToHexArray(this._rotBytes(temp)));
            // console.log('subBytes', this._byteArrayToHexArray(this._subBytes(this._rotBytes(temp))));
            // console.log('xorBytes1', this._byteArrayToHexArray(this._xorBytes1(this._subBytes(this._rotBytes(temp)), this.args.rcon[i / 4 - 1])));
            temp = this._xorBytes1(this._subBytes(this._rotBytes(temp)), this.args.rcon[i / 4 - 1]);
        }
