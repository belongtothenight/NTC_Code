let aes_enc = function AES_ENC(plaintext, key, iv, mode, padding, blockSize, outputType) {
    ...
    1. Init
        ...
        8. Init keysize=128 ,sbox, w, round(10, 12, 14), and state
    ...
    */
    ...
    const w = plaintext.match(/.{1,128}/g);
    if (blockSize == 128) {
        const round = 10;
        ...
        console.log('blockSize is not 128, 192 or 256');
        return;
    }
    if (print_status) {
